export default function handler(request, response) {
    const { nft, name, balance } = request.query;
    ...
    // Construct the Mini App JSON content separately
  ...
  <html>
    <head>
      ...
      <!-- Mini App Meta Tags -->
      <meta name="fc:miniapp" content='{"version":"1","imageUrl":"\${imageUrl}","button":{"title":"Mint Your Phunk","action":{"type":"launch_miniapp","name":"Bastard DeGAN Phunks","url":"\${appUrl}","splashImageUrl":"\${imageUrl}","splashBackgroundColor":"#17182b"}}}' />
